...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <div className="border-stroke mb-4 w-full rounded-sm border  p-10 px-6 py-3 text-base outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none bg-primary text-white">
          +91 7051499639
        </div>
        <div className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] p-10 px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none">
          email@email.email
        </div>
        <div className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] p-10 px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none">
          Beehama Ganderbal 191201
        </div>
